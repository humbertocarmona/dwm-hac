...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "Hack NF:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Rule rules[] = {
    ...
    */
    ...
    { "Qgis",           NULL,       NULL,             1 << 6,       0,           0,         0,        -1 },
    { "Alacritty",      NULL,       NULL,             0,            0,           1,         0,        -1 },
    { "kitty",          NULL,       NULL,             0,            0,           1,         0,        -1 },
    { "St",             NULL,       NULL,             0,            0,           1,         0,        -1 },
    { NULL,             "spterm",   NULL,             SPTAG(0),     1,           1,         0,        -1 },
    { NULL,             "spcalc",   NULL,             SPTAG(1),     1,           1,         0,        -1 },
    { NULL,           TERMCLASS,  "pulsemixer",     0,            1,           0,         0,        -1 },
    { "Pavucontrol",    NULL,       NULL,             0,            1,           0,         0,        -1 },
    { "Bluman-manager", NULL,       NULL,             0,            1,           0,         0,        -1 },
...
ResourcePref resources[] = {
        /* border  black */
        { "background",     STRING, &normbordercolor }, // #151515
        { "color2",         STRING, &selbordercolor },  // #99ad6a
        /* normal window */    
        { "background",     STRING, &normbgcolor }, // #151515
        { "color6",         STRING, &normfgcolor }, // #8fbfcd
        /* selected window */
        { "background",     STRING, &selbgcolor }, // #151515
        { "color14",        STRING, &selfgcolor }, // #80bfaf
